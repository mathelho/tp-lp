...
{fin = [(N 12),(N 66)], trans = 12},
{fin = [(N 55)], trans = 0},
{fin = [(N 32),(N 66)], trans = 14},
{fin = [(N 35)], trans = 0},
{fin = [(N 40),(N 66)], trans = 0},
{fin = [(N 14),(N 66)], trans = 17},
{fin = [(N 38)], trans = 0},
{fin = [(N 7),(N 66)], trans = 19},
{fin = [(N 7)], trans = 19},
{fin = [(N 27),(N 66)], trans = 0},
{fin = [(N 23),(N 66)], trans = 22},
{fin = [(N 62)], trans = 0},
{fin = [(N 57),(N 66)], trans = 0},
{fin = [(N 21),(N 66)], trans = 0},
{fin = [(N 25),(N 66)], trans = 0},
...
| 19 => (AND(yypos, yypos))
| 21 => (PLUS(yypos, yypos))
| 23 => (MINUS(yypos, yypos))
| 25 => (MULTI(yypos, yypos))
| 27 => (DIV(yypos, yypos))
| 30 => (DIF(yypos, yypos))
| 32 => (LESS(yypos, yypos))
| 35 => (LEQ(yypos, yypos))
...
| 42 => (LBRACKET(yypos, yypos))
| 44 => (RBRACKET(yypos, yypos))
| 46 => (LCHAVE(yypos, yypos))
| 48 => (RCHAVE(yypos, yypos))
| 50 => (LPAR(yypos, yypos))
| 52 => (RPAR(yypos, yypos))
| 55 => (SETAANON(yypos, yypos))
| 57 => (VIRGULA(yypos, yypos))
| 59 => (PIPE(yypos, yypos))
| 62 => (SETA(yypos, yypos))
| 64 => (UNDERLINE(yypos, yypos))
| 66 => let val yytext=yymktext() in error("\n***Lexer error: bad character ***\n"); raise Fail("Lexer error: bad character " ^ yytext) end
| 7 => let val yytext=yymktext() in INTEGER(strToInt(yytext), yypos, yypos) end
